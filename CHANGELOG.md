...
- Update rust crate log to v0.4.31 ([#240](https://github.com/BapRx/gsp/issues/240))
- Update rust crate log to v0.4.32 ([#241](https://github.com/BapRx/gsp/issues/241))
- Update rust crate skim to v4.8.0 ([#242](https://github.com/BapRx/gsp/issues/242))
- Update rust crate log to v0.4.33 ([#244](https://github.com/BapRx/gsp/issues/244))
- Update rust crate skim to v4.9.0 ([#246](https://github.com/BapRx/gsp/issues/246))
- Update rust crate skim to v4.10.0 ([#247](https://github.com/BapRx/gsp/issues/247))
- Update rust crate clap_complete to v4.6.6 ([#248](https://github.com/BapRx/gsp/issues/248))
- Update rust crate clap_complete to v4.6.7 ([#249](https://github.com/BapRx/gsp/issues/249))
- Update rust crate clap to v4.6.2 ([#251](https://github.com/BapRx/gsp/issues/251))
- Update rust crate serde to v1.0.229 ([#252](https://github.com/BapRx/gsp/issues/252))
- Update rust crate clap to v4.6.3 ([#253](https://github.com/BapRx/gsp/issues/253))
- Update rust crate serde_json to v1.0.151 ([#254](https://github.com/BapRx/gsp/issues/254))
- Update rust crate clap to v4.6.4 ([#255](https://github.com/BapRx/gsp/issues/255))
- Update rust crate clap_complete to v4.6.8 ([#256](https://github.com/BapRx/gsp/issues/256))
- Update rust crate clap to v4.6.5 ([#257](https://github.com/BapRx/gsp/issues/257))
- Update rust crate clap to v4.6.6 ([#258](https://github.com/BapRx/gsp/issues/258))
- Update rust crate clap_complete to v4.6.9 ([#259](https://github.com/BapRx/gsp/issues/259))
- Update rust crate log to v0.4.34 ([#260](https://github.com/BapRx/gsp/issues/260))
...
- Update rust crate clap to v4.5.52 ([#193](https://github.com/BapRx/gsp/issues/193))
- Update rust crate clap to v4.5.53 ([#194](https://github.com/BapRx/gsp/issues/194))
- Update rust crate clap_complete to v4.5.61 ([#195](https://github.com/BapRx/gsp/issues/195))
- Update actions/checkout action to v6
- Update rust crate log to v0.4.29 ([#197](https://github.com/BapRx/gsp/issues/197))
- Update rust crate clap_complete to v4.5.62 ([#199](https://github.com/BapRx/gsp/issues/199))
- Update rust crate serde_json to v1.0.146 ([#200](https://github.com/BapRx/gsp/issues/200))
- Update rust crate serde_json to v1.0.147 ([#201](https://github.com/BapRx/gsp/issues/201))
- Update rust crate serde_json to v1.0.148 ([#202](https://github.com/BapRx/gsp/issues/202))
- Update rust crate clap_complete to v4.5.63 ([#203](https://github.com/BapRx/gsp/issues/203))
- Update actions/cache action to v5
- Update rust crate clap_complete to v4.5.64 ([#204](https://github.com/BapRx/gsp/issues/204))
- Update rust crate clap to v4.5.54 ([#205](https://github.com/BapRx/gsp/issues/205))
- Update rust crate serde_json to v1.0.149 ([#206](https://github.com/BapRx/gsp/issues/206))
- Update rust crate clap_complete to v4.5.65 ([#207](https://github.com/BapRx/gsp/issues/207))
- Update rust crate clap to v4.5.55 ([#209](https://github.com/BapRx/gsp/issues/209))
- Update rust crate clap to v4.5.56 ([#210](https://github.com/BapRx/gsp/issues/210))
- Update rust crate clap to v4.5.57 ([#212](https://github.com/BapRx/gsp/issues/212))
- Update rust crate clap to v4.5.58 ([#213](https://github.com/BapRx/gsp/issues/213))
- Update rust crate clap_complete to v4.5.66 ([#214](https://github.com/BapRx/gsp/issues/214))
- Update rust crate clap to v4.5.59 ([#216](https://github.com/BapRx/gsp/issues/216))
- Update rust crate clap to v4.5.60 ([#217](https://github.com/BapRx/gsp/issues/217))
- Update rust crate clap to v4.6.0 ([#219](https://github.com/BapRx/gsp/issues/219))
- Update rust crate clap_complete to v4.6.0 ([#220](https://github.com/BapRx/gsp/issues/220))

### Other

- Add pre-commit hooks and mise config

### Refactor

- Consolidate gcloud command execution

### Testing

- Add integration tests for gsp CLI
